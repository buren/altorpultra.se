              ...
              <React.Fragment key={e.runner.id}>
                ...
                >
                  ...
                  <td className="px-3 py-2 font-medium">
                    <Link href={`/race/runner/${e.runner.bib}`} className="hover:underline" onClick={(ev) => ev.stopPropagation()}>
                      {e.runner.name}
                    </Link>
                  </td>
                  ...
                  <tr>
                    <td colSpan={(showGender ? 8 : 7) + (now ? 1 : 0)} className="bg-gray-50 px-6 py-3">
                      <p className="text-sm font-semibold text-gray-500 mb-2">
                        ...
                        <Link href={`/race/runner/${e.runner.bib}`} className="ml-2 text-xs font-normal text-blue-500 hover:underline">View profile &rarr;</Link>
                      </p>
