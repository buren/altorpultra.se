...
import { buildItraWorkbook } from "@/lib/race/itra-export";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const xlsx = await buildItraWorkbook(
      {
    ...
    return new NextResponse(xlsx, {
      headers: {
        ...
        "Content-Disposition": `attachment; filename="altorp-ultra-${edition.year}-itra.xlsx"`,
      },
    });
  } catch (err: any) {
